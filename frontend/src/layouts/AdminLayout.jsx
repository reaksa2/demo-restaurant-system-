...
import { LayoutGrid, Building2, Users, Copy, UtensilsCrossed, ClipboardList, BarChart3, Menu, X } from 'lucide-react'
...
export default function AdminLayout() {
  ...
  const navItems = [
    ...
    { to: '/admin/ordering', label: 'Ordering', icon: ClipboardList },
